...
public class DifferentialDriveConstants {
    ...
    private static final TalonFX RIGHT_FRONT_MOTOR = new TalonFX(RIGHT_FRONT_MOTOR_ID);
    private static final TalonFX RIGHT_REAR_MOTOR = new TalonFX(RIGHT_REAR_MOTOR_ID);
    private static final TalonFX LEFT_FRONT_MOTOR = new TalonFX(LEFT_FRONT_MOTOR_ID);
    private static final TalonFX LEFT_REAR_MOTOR = new TalonFX(LEFT_REAR_MOTOR_ID);
    private static final MotorControllerGroup RIGHT_MOTORS = new MotorControllerGroup(RIGHT_FRONT_MOTOR, RIGHT_REAR_MOTOR);
    private static final MotorControllerGroup LEFT_MOTORS = new MotorControllerGroup(LEFT_FRONT_MOTOR, LEFT_REAR_MOTOR);
